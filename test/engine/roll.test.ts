  ...
  tag_sets: [
    {
      ...
      // "group|side|type"; mod() above sets type = groups[0], so group and type coincide here.
      tiers: {
        "IncreasedLife|prefix|IncreasedLife": [1, 0],
        "DefencesPercent|prefix|DefencesPercent": [2],
        "PhysicalDamage|prefix|PhysicalDamage": [3],
        "FireResistance|suffix|FireResistance": [4],
        "ColdResistance|suffix|ColdResistance": [5],
        "Strength|suffix|Strength": [6],
      },
    },
  ],
  essences: [
